...
from lesson_2.common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
...
from lesson_2.decos import log
from lesson_2.errors import ReqFieldMissingError, ServerError, IncorrectDataReceivedError

from lesson_2.logs.configs.config_client_log import LOGGER as CLIENT_LOGGER  # Инициализация клиентского логера
from lesson_2.metaclasses import ClientMaker
